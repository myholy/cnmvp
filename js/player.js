...
class PlayerCreator {
    constructor() {
        ...
        this.render_doms = { //切换歌曲时需要渲染的dom组
            ...
            image: $('.music-player__image img'), //背景
    ...
    renderSongStyle() {
        ...
        this.render_doms.image.prop('src', 'https://myholy.github.io/cnmvp/img/logo128.png'); //CD
        this.render_doms.blur.css('background-image', 'url("' + 'https://myholy.github.io/cnmvp/img/logo128.png' + '")'); //背景
